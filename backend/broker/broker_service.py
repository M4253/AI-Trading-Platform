...
class _BrokerImpl:
    """Legacy local simulator retained for backwards-compatible read models.

    It never selects or contacts a real broker.  New execution flows use the
    richer PaperTradingEngine.
    """
...
class BrokerService(_BrokerImpl):
    """Paper-only legacy broker facade.

    It cannot be switched to IBKR by configuration.
    """
    pass
